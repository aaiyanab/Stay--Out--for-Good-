  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-[5%]">
      <div className="text-center max-w-[560px]">
        ...
        <p className="text-white/60 text-lg leading-relaxed mb-10">The page you&apos;re looking for doesn&apos;t exist or may have been moved. Let&apos;s get you back on track.</p>
